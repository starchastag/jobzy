    ...
    return (
        <section className="w-full">
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
                <div className="bg-white mb-4 px-2 py-8">
                    <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                        <h2 className="font-heading mb-4 font-bold tracking-tight text-gray-900 text-3xl sm:text-5xl">
                            Contact Authentic Jobs
                        </h2>
                    ...
                    <div className="grid md:grid-cols-2">
                        <div className="h-full pr-6">
                            <p className="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                Here You can ask your query or Question ! Our Expert connect you as soon as possible with perfect solution for you !
                            </p>
                            <h2 className="font-medium mb-6 font-bold tracking-tight text-gray-900 dark:text-white text-2xl sm:text-4xl">
                            Here some other Way to Connect Us
                        </h2>
                            <ul className="mb-6 md:mb-0">
                                <li className="flex">
                                    ...
                                    <div className="ml-4 mb-4">
                                        ...
                                        <p className="text-gray-600 dark:text-slate-400">1230 BCC Apartment Faizabad Road Lucknow</p>
                                ...
                                <li className="flex">
                                    ...
                                    <div className="ml-4 mb-4">
                                        ...
                                        <p className="text-gray-600 dark:text-slate-400">Mobile: +91 6386109790</p>
                                        <p className="text-gray-600 dark:text-slate-400">Mail: Rojers6386@gmail.com</p>
                                    </div>
                                </li>
                                <li className="flex">
                                    <div className="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
                                    ...
                                    <div className="ml-4 mb-4">
                                        <h3 className="mb-2 text-lg font-medium leading-6 text-gray-900 dark:text-white">Response Time</h3>
                                        <p className="text-gray-600 dark:text-slate-400">Monday - Friday: 10:00AM - 6:00PM</p>
                                        <p className="text-gray-600 dark:text-slate-400">Saturday &amp; Sunday: 12:00PM - 06:00PM</p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                            ...
                            <form id="contactForm">
                                ...
                                <div className="text-center">
                                    <button type="submit" className="w-full bg-blue text-white px-6 py-3 font-xl rounded-md sm:mb-0">Send Message</button>
                                </div>
                            </form>
                        </div>
                    </div>
